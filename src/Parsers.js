...
class CSVReader {
    ...
    static _test() {
        function test(expected, actual) {
            ...
            let result = expectedStr === actualStr;
            if (result) {
                console.log(result);
            } else {
                console.log(`${result} - expected: ${expectedStr}, but was: ${actualStr}`);
            }
        }

        {
            console.log('testCSVParseNoQuotes');
            let reader = new CSVReader(' a, b \t, c c c \n\n,,xx x\n,');
            test(["a", "b", "c c c"], reader.readLine());
            test([], reader.readLine());
            test(["", "", "xx x"], reader.readLine());
            test(reader.readLine(), null);
        }
        {
        ...
        }
        {
            ...
            let reader = new CSVReader('"a""b""c"\n"""b""c"\n"a""b"""\n""""');
