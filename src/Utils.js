...
export class Utils {
    ...
    static colourNameToHex(colour) {
        ...
        if (typeof COLORS[normalized] !== 'undefined') {
    ...
    static createFilterLabel(f) {
        // note: color is checked & in hex format
        let attributes = {
            class: 'badge badge-info'
        };
        if (f.color != null) {
            attributes.style = `background-color: ${f.color};`;
        }
        return DomBuilder.span(f.name, attributes);
    }
}
